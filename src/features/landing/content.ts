...
export const features = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "Umberleaf reads like an editor for rhythm, clarity and structure, and asks the questions a good one would. It never writes for you. Your voice stays yours.",
    },
    {
      icon: BookOpen,
    ...
    },
    {
      ...
      description:
        "Essays, stories and poems, released when they're ready, typeset beautifully by default, living at a permanent address you control.",
    },
    {
      icon: Sprout,
